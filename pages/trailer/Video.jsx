      ...
      <>
        <section className="trailer">
          <div className="trailer__video-wrapper previous">
            ...
            <video className="trailer__video" poster="../../assets/images/trailer-korean.jpg">
            ...
            <img className="trailer__play" src="../../assets/images/play.png" alt="재생" />
          </div>
          <div className="trailer__video-wrapper">
            <h2 className="trailer__title">Teaser trailer</h2>
            <video className="trailer__video" poster="../../assets/images/trailer-teaser.jpg">
          ...
          <div className="trailer__video-wrapper next">
            <h2 className="trailer__title">Final trailer</h2>
              <video className="trailer__video" poster="../../assets/images/trailer-final.jpg">
